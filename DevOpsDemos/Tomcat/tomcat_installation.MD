...
```sh 
  ...
  rm -rf apache-tomcat-8.5.38.zip
...
[root@ip-172-31-9-248 bin]# vi /opt/tomcat/webapps/host-manager/META-INF/context.xml
[root@ip-172-31-9-248 bin]# vi /opt/tomcat/webapps/manager/META-INF/context.xml
